...
class AdminController extends Controller
{
  ...
  $data = $dashboardService->getDashboardData();
    ...
    return view('admin.dashboard',[
      ...
      'paymentsStats'             => $data['chart_data']['payments_stats'],
  ...
  public function reports_page(ReportService $reportService)
  {
    ...
    return view('admin.reports.reports',[
      ...
      'payments_stats'           => $data['charts']['payments_stats'],
      'income_stats'             => $data['charts']['income_stats'],
      'clients_stats'            => $data['charts']['clients_stats'],

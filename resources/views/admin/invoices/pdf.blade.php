...
<head>
    ...
    <style>
        ...
        .info-table { width: 100%; margin-bottom: 25px; border-collapse: separate; border-spacing: 0 8px; }
        .info-table td { background: #f6f8fa; padding: 12px 14px; border-radius: 8px; vertical-align: top; font-size: 1em; }
        ...
        .footer { text-align: left; margin-top: 40px; font-size: 1.1em; color: #2980b9; }
    </style>
</head>
<body>
